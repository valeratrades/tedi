...
pub use tedi_core::{
	...
	IssueRef, IssueSelector, IssueTimestamps, LinkedIssueMeta, MAX_INDEX_DEPTH, MAX_LINEAGE_DEPTH, MAX_TITLE_LENGTH, Marker, MilestoneLink, MilestoneRef, ParseError, RepoInfo, TaskView,
	TitleInGitPathError, VirtualIssue, parse_blockers_from_embedded, split_blockers,
};
